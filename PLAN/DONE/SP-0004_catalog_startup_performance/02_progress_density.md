...
1. Update `src/StreamsPlayer.App/MainWindow.xaml` and `MainWindow.xaml.cs` to show an accessible indeterminate catalog activity indicator before local state is read and during remote refresh; hide it on all terminal paths.
