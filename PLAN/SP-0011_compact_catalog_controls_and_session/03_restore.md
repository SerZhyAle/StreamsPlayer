...
4. [Partial] Build, test, then run and observe the compact layout and restart restoration. Layout was observed; restart restoration awaits a run without the user's existing StreamsPlayer process sharing local state.
