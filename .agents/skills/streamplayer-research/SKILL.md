---
name: streamplayer-research
description: Perform an evidence-first, read-only investigation of a StreamPlayer feature area, bug, architecture question, or external contract before a non-trivial change.
---
