---
name: streamplayer-ui-clarify
description: Resolve meaningful user-facing ambiguity in StreamPlayer WPF UI, CLI output, errors, labels, or fallback behaviour before implementation.
---
