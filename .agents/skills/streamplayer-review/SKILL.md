---
name: streamplayer-review
description: Review current StreamPlayer changes for correctness, regression risk, architecture, anti-slop patterns, and missing validation.
---
