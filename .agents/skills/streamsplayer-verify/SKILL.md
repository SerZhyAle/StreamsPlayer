---
name: streamsplayer-verify
description: Build and observe a minimal StreamsPlayer scenario, including WPF UI or the catalog harness when appropriate, and report PASS or FAIL evidence.
---
