---
name: streamsplayer-quick
description: Apply one trivial deterministic StreamsPlayer edit such as a typo, one string, or one local constant. Do not use for behavioural or design changes.
---
