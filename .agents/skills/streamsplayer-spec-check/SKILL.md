---
name: streamsplayer-spec-check
description: Audit a StreamsPlayer implementation against its strategic and tactical ticket using the live working tree and concrete checks.
---
