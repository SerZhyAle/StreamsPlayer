---
name: streamplayer-park
description: Capture a real but out-of-scope StreamPlayer finding as a minimal Draft ticket, then return to the active task without fixing it.
---
