const translations = {
  en: {
    ...
    "status-title": "In active development",
    "status-description": "The first public packages are being prepared. Follow the repository for source code and release updates.",
    "status-source": "Open GitHub",
    "status-plan": "Distribution plans",
    "features-title": "Built around the stream",
    "features-description": "The essentials for finding, keeping, and playing internet streams without turning the player into a dashboard.",
    "feature-catalog-title": "One catalog, your choices",
    "feature-catalog-description": "Filter by category, language, country, and media type. Search, sort, and pin the channels you return to.",
    ...
    "distribution-description": "These channels are planned, but none should be treated as a published download until its first approved release appears.",
  ...
  ru: {
    ...
    "status-title": "В активной разработке",
    "status-description": "Первые публичные пакеты готовятся. Следите за репозиторием, исходным кодом и новостями о выпуске.",
    "status-source": "Открыть GitHub",
    "status-plan": "Планы распространения",
    "features-title": "Всё вокруг потока",
    "features-description": "Главное для поиска, сохранения и воспроизведения интернет-потоков — без превращения плеера в перегруженную панель.",
    "feature-catalog-title": "Один каталог, ваш выбор",
    "feature-catalog-description": "Фильтруйте по категории, языку, стране и типу медиа. Ищите, сортируйте и закрепляйте нужные каналы.",
    ...
    "distribution-description": "Эти каналы запланированы, но ни один из них не считается доступной загрузкой до первого утверждённого выпуска.",
  ...
  uk: {
    ...
    "status-title": "В активній розробці",
    "status-description": "Перші публічні пакети готуються. Стежте за репозиторієм, вихідним кодом і новинами про випуск.",
    "status-source": "Відкрити GitHub",
    "status-plan": "Плани поширення",
    "features-title": "Усе навколо потоку",
    "features-description": "Головне для пошуку, збереження та відтворення інтернет-потоків — без перетворення плеєра на перевантажену панель.",
    "feature-catalog-title": "Один каталог, ваш вибір",
    "feature-catalog-description": "Фільтруйте за категорією, мовою, країною і типом медіа. Шукайте, сортуйте й закріплюйте потрібні канали.",
    ...
    "distribution-description": "Ці канали заплановані, але жоден із них не є доступним завантаженням до першого затвердженого випуску.",
