...
Use strong reasoning for architecture, review, specifications, and diagnosis. Use lighter reasoning for bounded mechanical work once ambiguity is gone. Keep raw output under `tmp/` and return concise, verifiable conclusions rather than pasting logs into durable documentation.
