...
- Відкривайте рідковживані дії з одного меню **«Операції»** у верхній панелі:
  ...
  історія, додати потік і **«Імпортувати канали з інтернету»**.
...
- Довірте вибір каталогу: **«Випадкова станція»** в меню **«Операції»** бере одну
  ...
  пошук, відкриті фасети та активна добірка, а приховані вами канали, відео й
  адреси RTSP не випадають ніколи. Станція, що відмовила або, з’єднавшись, мовчить
...
- Згортайте каталог у компактну панель радіо, поки грає станція. Кнопка поруч із
  кнопкою відтворення ховає каталог і лишає маленьке вікно, яке тримається поверх
  інших програм і несе станцію, поточний трек, гучність, зупинку, таймер сну з
  відліком і «Випадкову станцію». Два види - один застосунок: один пункт у панелі
