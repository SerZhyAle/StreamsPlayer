...
- Зберігайте стан каталогу, ручні записи, закріплення, добірки, приховані канали каталогу, історію прослуховування, кешовані кадри прев’ю та діагностичний журнал поточного сеансу `Current.log` у
